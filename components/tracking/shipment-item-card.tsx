...
export function ShipmentItemCard({ shipment, className }: ShipmentItemCardProps) {
  ...
  return (
    <div className={cn('bg-white border border-slate-200/60 rounded-2xl p-4 shadow-sm space-y-4', className)}>
      <div>
      ...
      <div className="flex items-center justify-between gap-4 bg-slate-50/50 border border-slate-100 rounded-xl p-3">
